...
func runAPI() error {
	...
	http.HandleFunc("/v1/notifications", func(w http.ResponseWriter, r *http.Request) {
		...
		id := uuid.NewString()
		envlp := Envelope{ID: id, Attempt: 0, Notification: n}
...
func runWorker() error {
	...
	p := Processor{
		...
		Republish: func(ctx context.Context, envlp Envelope) error {
			return Publish(ctx, prodWriter, envlp)
		},
		SendToDLQ: func(ctx context.Context, envlp Envelope) error {
